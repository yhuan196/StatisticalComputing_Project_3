...
```
\begin{center}
Figure 2. the Average Speed of Hurricanes
\end{center}
As the year increases, the average speed of hurricanes first decreases, then increases a little bit, and finally decreases.
...
\end{center}
The hurricanes in the data have been compared based on their different nature ratings. This number of nature ratings is larger than the number of hurricanes due to the fact that some hurricanes may have different nature ratings at different times.
