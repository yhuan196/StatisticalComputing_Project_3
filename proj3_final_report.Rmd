...
Using the posterior estimates of $\mu$, we observe that an increase in the current wind speed and changes in wind speed are linked to an increase in wind speed in the near future. 
