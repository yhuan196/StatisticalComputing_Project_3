...
dt_long %>% 
  ...
  geom_point() +
  scale_y_continuous("Average Speed")
```
\begin{center}
Figure 2.the Average Speed of Hurricanes in Each Month
\end{center}
...
```
\begin{center}
Figure 4.the Average Speed of Hurricanes in Each Year
\end{center}
...
ggplot(data = storms_nature_name) + 
  geom_bar(aes(x = Nature,fill=Nature))
```
\begin{center}
Figure 5. the Count of Hurricanes in Each Nature
\end{center}
...
```
\begin{center}
Figure 6. the Average Speed of Hurricanes in Each Nature
\end{center}
