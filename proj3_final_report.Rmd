...
\end{center}
Figure 2 shows that as the year increases, the average speed of hurricanes first decreases, then increases a little bit, and finally decreases.
...
where $N=\frac{Z_i^\top Z_i}{\sigma^2}+{\boldsymbol A}$, $M=\frac{Z_i^\top Y_i-Z_i^\top X_i\gamma}{\sigma^2}+\mu {\boldsymbol A}$
